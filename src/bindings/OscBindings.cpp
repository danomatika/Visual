...
static int _wrap_Message_getArgAsInt32(lua_State* L) { int SWIG_arg = 0; ofxOscMessage *arg1 = (ofxOscMessage *) 0 ; int arg2 ;
  int32_t result; SWIG_check_num_args("ofxOscMessage::getArgAsInt32",2,2)
...
static int _wrap_Message_setAddress(lua_State* L) { int SWIG_arg = 0; ofxOscMessage *arg1 = (ofxOscMessage *) 0 ;
  std::string arg2 ; SWIG_check_num_args("ofxOscMessage::setAddress",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("ofxOscMessage::setAddress",1,"ofxOscMessage *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("ofxOscMessage::setAddress",2,"std::string");
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ofxOscMessage,0))){
    SWIG_fail_ptr("Message_setAddress",1,SWIGTYPE_p_ofxOscMessage); }  (&arg2)->assign(lua_tostring(L,2),lua_rawlen(L,2));
  (arg1)->setAddress(arg2); return SWIG_arg; if(0) SWIG_fail; fail: lua_error(L); return SWIG_arg; }
static int _wrap_Message_setRemoteEndpoint(lua_State* L) { int SWIG_arg = 0; ofxOscMessage *arg1 = (ofxOscMessage *) 0 ;
  std::string arg2 ; int arg3 ; SWIG_check_num_args("ofxOscMessage::setRemoteEndpoint",3,3)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("ofxOscMessage::setRemoteEndpoint",1,"ofxOscMessage *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("ofxOscMessage::setRemoteEndpoint",2,"std::string");
...
static int _wrap_Message_addStringArg(lua_State* L) { int SWIG_arg = 0; ofxOscMessage *arg1 = (ofxOscMessage *) 0 ;
  std::string arg2 ; SWIG_check_num_args("ofxOscMessage::addStringArg",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("ofxOscMessage::addStringArg",1,"ofxOscMessage *");
  if(!lua_isstring(L,2)) SWIG_fail_arg("ofxOscMessage::addStringArg",2,"std::string");
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ofxOscMessage,0))){
    SWIG_fail_ptr("Message_addStringArg",1,SWIGTYPE_p_ofxOscMessage); }  (&arg2)->assign(lua_tostring(L,2),lua_rawlen(L,2));
  (arg1)->addStringArg(arg2); return SWIG_arg; if(0) SWIG_fail; fail: lua_error(L); return SWIG_arg; }
static int _wrap_Message_addBlobArg(lua_State* L) { int SWIG_arg = 0; ofxOscMessage *arg1 = (ofxOscMessage *) 0 ;
  ofBuffer arg2 ; ofBuffer *argp2 ; SWIG_check_num_args("ofxOscMessage::addBlobArg",2,2)
  if(!SWIG_isptrtype(L,1)) SWIG_fail_arg("ofxOscMessage::addBlobArg",1,"ofxOscMessage *");
  if(!lua_isuserdata(L,2)) SWIG_fail_arg("ofxOscMessage::addBlobArg",2,"ofBuffer");
  if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ofxOscMessage,0))){
